      ...
      >
        ...
        <div className="hidden lg:flex lg:gap-x-12">
          <div className="relative">
            ...
            Entering: "transition ease-out duration-200" From: "opacity-0
            translate-y-1" To: "opacity-100 translate-y-0" Leaving: "transition
            ease-in duration-150" From: "opacity-100 translate-y-0" To:
              ...
              <div className="space-y-2 py-6">
                <div className="-mx-3">
                  <button
                    ...
                    aria-expanded="false"
                  >
                    Product Expand/collapse icon, toggle classNamees based on
                    menu open state. Open: "rotate-180", Closed: ""
                    <svg
